...
import "./index.css";
import image1 from "./Images/graph1.png";
import image2 from "./Images/graph2.png";
import image3 from "./Images/graph3.png";
import image4 from "./Images/graph4.png";
import image5 from "./Images/graph5.png";
import image6 from "./Images/graph6.png";
  ...
  const onDragEnd = (result) => {
    ...
    if (sourceDroppableId === "col1" && destinationDroppableId !== "col1") {
      ...
      if (destinationDroppableId === "col2") {
        ...
        newCol2Items.splice(destination.index, 0, {
          ...itemToAdd,
          id: `${itemToAdd.id}-copy-${Date.now()}`,
        });
        setItems((prevItems) => ({
          ...prevItems,
          col2: newCol2Items,
      ...
      <div className="App font-sans mx-8">
        <header className="flex justify-between p-4 shadow-md bg-white">
          <div className="flex items-center">
            ...
            <h3 className="font-bold">Run Workout</h3>
          </div>
                        ...
                        >
                          ...
                          <div className="flex  p-2 justify-between items-center">
                            ...
                            <div className="flex gap-3">
                              <span className="border border-spacing-1 p-1 rounded-md">
                                {item.size} Km
                              </span>
                              <span className="border border-spacing-1 p-1 rounded-md">
                                <svg
                          ...
                          <div>
                            <div class="line-with-text">
                              <button className="border border-spacing-14 border-blue-600 p-2 rounded-full">
                                ADD SUBSET
                              </button>
                            </div>
                          </div>
